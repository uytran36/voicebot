...
//campaign detail autocall
export async function requestDownLoadFileExcel(headers, data) {
  const url = `${api.UMI_API_BASE_URL}/campaign_report/download_excel_report_file`;
  return request(url, {
    method: 'POST',
    headers,
    data,
...
export async function requestCheckPayment(headers) {
  return request(`${api.UMI_API_BASE_URL}/campaign/get_text_function_check_payment`, {
    method: 'GET',
    headers,
  });
}

export async function requestGetStatisticsReport(headers, data) {
  return request(`${api.UMI_API_BASE_URL}/campaign_report/detail_campaign_statistics_report`, {
    method: 'POST',
    headers,
    data
  });
...
export async function requestGetCallStatisticsByDay(headers, data) {
  return request(`${api.UMI_API_BASE_URL}/campaign_report/call_statistics_by_day`, {
    method: 'POST',
    headers,
    data
  });
...
export async function requestGetNumberOfErrorCall(headers, data) {
  return request(`${api.UMI_API_BASE_URL}/campaign_report/get_the_number_of_error_calls`, {
    method: 'POST',
    headers,
    data
  });
