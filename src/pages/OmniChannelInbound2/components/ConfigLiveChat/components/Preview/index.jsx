...
Preview.propTypes = {
  ...
  filterConfig: PT.func.isRequired,
};

function Preview(props) {
  const { configLiveChat, switchBeginChat, switchRegisterInfo, filterConfig } = props;
  return (
    <div className={styles.bodyWrapper}>
      <div className={styles.header} style={{ background: configLiveChat.Livechat_title_color }}>
        <div className={styles.leftHeader}>
          ...
          <span>{filterConfig(configLiveChat, 'livechat_title')?.value}</span>
        </div>
      ...
      <div className={styles.content}>
        {(switchRegisterInfo || switchBeginChat) && (
          <>
            {switchBeginChat && filterConfig(configLiveChat, 'greeting_chat_opening')?.active && (
              <div className={styles.chat}>
                <div className={styles.messageWrapper}>
                  <div className={styles.toWrapper}>
                    ...
                    <div
                      className={styles.to}
                      style={{ background: filterConfig(configLiveChat, 'visitor_color_popup')?.value, maxWidth: '100%' }}
                    >
                      <span style={{ color: filterConfig(configLiveChat, 'visitor_color_chat')?.value }}>
                        {filterConfig(configLiveChat, 'greeting_chat_opening')?.value}
                      </span>
                    </div>
                  </div>
            ...
            <div className={styles.formWrapper}>
              ...
              <div className={styles.noteForm}>
                <p>
                  {switchRegisterInfo &&
                    (filterConfig(configLiveChat, 'fullname_register')?.active ||
                    filterConfig(configLiveChat, 'phone_register')?.active ||
                    filterConfig(configLiveChat, 'email_register')?.active) &&
              ...
              {switchRegisterInfo && filterConfig(configLiveChat, 'fullname_register')?.active && (
              ...
              {switchRegisterInfo && filterConfig(configLiveChat, 'phone_register')?.active && (
                <div className={styles.formItem}>
                  <div className={styles.label}>
              ...
              {switchRegisterInfo && filterConfig(configLiveChat, 'email_register')?.active && (
                <div className={styles.formItem}>
                  <div className={styles.label}>
                    <span>Email</span>
                  </div>
              ...
              {switchBeginChat && filterConfig(configLiveChat, 'button_chat_info')?.active && (
            ...
            <div className={styles.chat}>
              <div className={styles.messageWrapper}>
                <div className={styles.toWrapper}>
                  ...
                  <div
                    className={styles.to}
                    style={{ background: filterConfig(configLiveChat, 'agent_color_popup')?.value }}
                  >
                    <span style={{ color: filterConfig(configLiveChat, 'agent_color_chat')?.value }}>
                      Tôi cần hỗ trợ
                    </span>
                  </div>
                </div>
              ...
              <div className={styles.messageWrapper}>
                <div className={styles.fromWrapper}>
                  <div
                    ...
                    style={{ background: filterConfig(configLiveChat, 'visitor_color_popup')?.value }}
                  >
                    <Paragraph
                      style={{ color: filterConfig(configLiveChat, 'visitor_color_chat')?.value }}
                      // ellipsis={{ rows: 1 }}
                    >
            ...
            <div className={styles.chat}>
              <div className={styles.messageWrapper}>
                <div className={styles.toWrapper}>
                  ...
                  >
                    <Paragraph
                      style={{ color: filterConfig(configLiveChat, 'agent_color_chat')?.value }}
                      ellipsis={{ rows: 3 }}
                    >
