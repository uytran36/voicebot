          ...
          <div className={styles.titleWrapper}>
            ...
            {/* {(detailCampaign?.status === 'running' || detailCampaign?.status === 'pending') && (
              <Button
                ...
                // onClick={() => console.log(detailCampaign)}
              >
                {detailCampaign?.status === 'pending' ? 'Bắt đầu' : 'Tạm dừng'}
              </Button>
            )} */}
            {detailCampaign?.status === 'Hoàn thành' && (
          ...
          {api.ENV === 'local' || api.ENV === 'dev' ? (
            <>
              ...
              <CardLayout
                ...
                // suffix={
                //   <Space size={15}>
                //     <SelectMultiple list={listType} callback={handleOkType} />
                //   </Space>
                // }
              >
                <AmountOutbound rangeDate={rangeDate} data={data} />
              </CardLayout>
              <CardLayout
                ...
                type="error"
              >
                <FailedErrorStatistic rangeDate={rangeDate} data={data} />
              </CardLayout>
            </>
          ) : (
            <CardLayout
