          ...
          {(api.ENV === 'local' || api.ENV === 'dev') && (
            <>
              <Form.Item
                ...
                wrapperCol={{ offset: 1 }}
              >
                {detailCampaign?.configuration?.call_back_configuration?.amount_call_back_times !==
                  undefined && (
                  <span>{`${detailCampaign?.configuration?.call_back_configuration?.amount_call_back_times} lần`}</span>
                )}
              </Form.Item>
              <Form.Item
                className={styles.formItem}
                ...
                wrapperCol={{ offset: 1 }}
              >
                {detailCampaign?.configuration?.call_back_configuration?.call_back_delay_minutes !==
                  undefined && (
                  <span>{`${detailCampaign?.configuration?.call_back_configuration?.call_back_delay_minutes} phút`}</span>
                )}
              </Form.Item>
            </>
          )}
          ...
          <Row>
            <div className={styles.header}>
              <div className={styles.icon}>
                <ClockCircleFilled style={{ color: '#526eff' }} />
              </div>
              <div className={styles.title}>
                <span>Thời gian đã cấu hình</span>
              </div>
            </div>
          </Row>
