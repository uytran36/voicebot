    ...
    },
    {
      ...
      intro: (
        <FormattedMessage
          ...
          defaultMessage="Voicebot Campaign giúp bạn thiết lập đa chiến dịch với hàng trăm cuộc gọi đi(Outbound Call) tới số lượng lơn khách hàng: Quản lý danh sách khách hàng, chuẩn hoá dữ liệu, quản lý đa chiến dịch, địa phương hoá voicebot, cá nhân hoá dữ liệu, báo cáo/phân tích realtime."
        />
      ),
      listIntroItem: [
