...
function General(props) {
  ...
  const renderChartCampaign = useCallback(() => {
    const typeReport = [
      ...
      //     {
      //       type: 'Đang chạy',
      //       value: reportCampaignDaily.campaign_running,
      //     },
      //     {
      //       type: 'Đang tạm dừng',
      //       value: reportCampaignDaily.campaign_scheduled,
      //     },
      //     {
      //       type: 'Chưa chạy',
      //       value: reportCampaignDaily.campaign_pending,
      //     },
      //     {
      //       type: 'Hoàn thành',
      //       value: reportCampaignDaily.campaign_complete,
      //     },
      //   ],
      // },
      // 'Cuộc gọi', 'Khách hàng', 'API', 'Ký tự'
    ];
