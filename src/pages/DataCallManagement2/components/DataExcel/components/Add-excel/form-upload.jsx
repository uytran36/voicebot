...
import { requestSaveValidatedExcel } from '@/services/datacall-management';
import fileDownload from 'js-file-download';

import { requestDownloadLink } from '@/services/datacall-management';
...
function RenderFormUpload({ headers, onCancel, dispatch, goToDetail }) {
  ...
  const handleImportFile = useCallback(
    (id, setSlideNumber, toggleException) => async () => {
      const res = await requestSaveValidatedExcel(headers, {
        call_data_id: id,
  ...
  return (
    ...
    >
      ...
      <Form.Item label="">
        <Checkbox onChange={onCheckboxAllowDownload}>
          Cho phép người khác tải về file dữ liệu
        </Checkbox>
      </Form.Item>
      <p>
