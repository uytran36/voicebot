    ...
    <div className={styles['options']}>
      {type === 'year' && (
        <Form.Item noStyle {...restField} name={[name, detail]}>
          <Select className={styles['select-value']} onChange={(value) => removeYear(value)}>
            {yearVal.map((item) => (
      ...
      {type === 'month' && (
        <Form.Item noStyle {...restField} name={[name, detail]}>
          <Select className={styles['select-value']} onChange={(value) => removeMonth(value)}>
            {monthVal.map((item) => (
      ...
      {type === 'dayInMonth' && (
        <Form.Item noStyle {...restField} name={[name, detail]}>
          <Select className={styles['select-value']} onChange={(value) => removeDayInMonth(value)}>
      ...
      {type === 'dayInWeek' && (
        <Form.Item noStyle {...restField} name={[name, detail]}>
          <Select className={styles['select-value']} onChange={(value) => removeDayInWeek(value)}>
      ...
      {type === 'weekInYear' && (
        <Form.Item noStyle {...restField} name={[name, detail]}>
          <Select className={styles['select-value']} onChange={(value) => removeWeekInYear(value)}>
      ...
      {type === 'weekInMonth' && (
        <Form.Item noStyle {...restField} name={[name, detail]}>
          <Select className={styles['select-value']} onChange={(value) => removeWeekInMonth(value)}>
      ...
      {(type === '' || type === undefined) && (
        <Form.Item noStyle {...restField} name={[name, detail]}>
          <Select className={styles['select-value']}></Select>
        </Form.Item>
      )}
    </div>
  );
