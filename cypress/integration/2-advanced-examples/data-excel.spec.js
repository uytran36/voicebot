...
context('Network Requests', () => {
  ...
  it('test voicebot', () => {
    ...
    //Thêm dữ liệu
    cy.get(
      'div.ant-space.ant-space-horizontal.ant-space-align-center.ant-pro-table-list-toolbar-right > div > div > div:nth-child(2) > button'
    ).click({ force: true });
    cy.get(
      'div > div > div > form > div:nth-child(1) > div.ant-col.ant-form-item-control.ant-col-sm-18.ant-col-md-20 > div > div > span > input'
    ).type('test integration', { force: true });
    cy.get(
      'div > div > div > form > div:nth-child(2) > div.ant-col.ant-form-item-control.ant-col-sm-18.ant-col-md-20 > div > div > span > div.ant-upload.ant-upload-select.ant-upload-select-text > span > input[type=file]'
    ).click({ force: true });
  });
});
